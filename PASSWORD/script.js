function generatePassword() {
    ...
    var lowercase = document.getElementsByName("lowercase")[0].checked;
    var uppercase = document.getElementsByName("uppercase")[0].checked;
    var numbers = document.getElementsByName("numbers")[0].checked;
    var symbols = document.getElementsByName("symbols")[0].checked;
    var allowSpaces = document.getElementsByName("spaces")[0].checked;
